...
app.post("/syllabus", classController.createSyllabus);//Create Syllabus
app.get("/syllabus/:classID", classController.getSyllabusByClassId);//Get Syllabus by Class ID
